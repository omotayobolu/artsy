...
const Creators = () => {
  return (
    <div className="relative bg-light-grey lg:px-[8%] sm:px-[5%] px-[3%] py-[5%]">
      ...
      <p
        className="my-8 text-[rgba(0,0,0,75%)] leading-[130%] lg:text-xl text-lg
       font-extralight"
      >
      ...
      <span className="font-bold lg:text-[170px] sm:text-[120px] text-[100px] leading-[155.5%] text-[#161616] line-through right-0 flex items-center justify-end">
        1985
      </span>
